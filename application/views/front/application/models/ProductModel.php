...
class ProductModel extends CI_Model {
	...
	public function add_product_model($product_image){
		...
		$data['pro_temp'] = $this->input->post('pro_temp',true);
		...
		$data['pro_country'] = $this->input->post('pro_country',true);
	...
	public function sum_product_price(){
		$data = $this->db->select('sum(product_price) as total')
	...
	// public function get_all_recomm_product()
	// {
	//    $data  = $this->db->order_by('rand()')
 //              ->limit(4)
 //              ->from('tbl_product')
 //              ->get()
 //              ->result();
 //       return $data;
	...
	public function get_all_recomm_product()
	{
      ...
      return $data;
		...
		public function get_all_recomm1_product()
	{
	   $data = $this->db->select('*')
			->from('tbl_product')
			->order_by('pro_id','asc')
