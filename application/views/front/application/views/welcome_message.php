...
>>>>>>> e0440231784b6f6c0671a7d8c5662350652f2826
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target="#site-navbar" data-offset="200">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark site_navbar bg-dark site-navbar-light" id="site-navbar">
      <div class="container">
        <a class="navbar-brand" href="<?php echo base_url();?>">EatWell</a>
      ...
      <div class="container">
        <div class="row site-custom-gutters">
          ...
          <div class="col-md-4 site-animate">
            <a href="<?php echo base_url(); ?>assets/images/menu_1.jpg" class="site-thumbnail image-popup">
              <img src="<?php echo base_url(); ?>assets/images/menu_1.jpg" alt="Free Template by colorlib.com" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 site-animate">
            <a href="<?php echo base_url(); ?>assets/images/menu_2.jpg" class="site-thumbnail image-popup">
              <img src="<?php echo base_url(); ?>assets/images/menu_2.jpg" alt="Free Template by colorlib.com" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 site-animate">
            <a href="<?php echo base_url(); ?>assets/images/menu_3.jpg" class="site-thumbnail image-popup">
