...
<div class="right_col" role="main">
    <div class="">
        ...
        <hr>
        <a class="btn btn-primary" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample"> Add A new Pic</a>

        <div class="row">
            <div class="col-md-8 col-md-offset-2">
            <div class="collapse" id="collapseExample">
            <?php echo validation_errors(); ?> 
			<?php echo form_open_multipart('admin/pics/add'); ?>
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <label for="mileage">Dish Name:</label>
                            <input type="text" step="any" class="form-control" name="pic_name" placeholder="Dish Name" required>
                        </div>
                        <div class="col-xs-6">
                            <label for="mileage">pic:</label>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php foreach($pics as $vehicle) : ?>
                                    
                                    <tr class="">
                                    
                                        <td><?php echo $vehicle['pic_name']; ?></td>
