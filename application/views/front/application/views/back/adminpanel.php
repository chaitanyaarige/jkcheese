        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-user-o fa-fw"></i>Client Option<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url();?>add-client">Add Client</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>client-list">Client List</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        <a href="<?php echo base_url()?>news"><i class="fa fa-flask fa-fw"></i>News Letter</a>
                    </li>
                     <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Horeco Products<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url();?>add-horeca">Add Product</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>horeca-list">Product List</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
