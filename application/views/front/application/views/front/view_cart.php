        ...
        <div class="ui column">
            <!--  <div class="css_button">Proceed To Checkout <i class="fa fa-arrow-right"> </i></div>  -->
              <form action="<?php echo base_url()?>update-cart-qty" method="post" >    
                            ...
                            <div class="css_button" ><a   href="<?php echo base_url()?>payment" style="color:white">Proceed To Checkout <i class="fa fa-arrow-right"></i></a></div>
                            <?php } elseif($customer_id!=NULL && $this->cart->total_items()!=Null){?>
                            <div class="css_button" ><a  href="<?php echo base_url()?>billing" style="color:white">Proceed To Checkout <i class="fa fa-arrow-right"></i></a></div>
                            <?php }elseif($this->cart->total_items()!=Null){ ?>
                            <div class="css_button" ><a   href="<?php echo base_url()?>checkout" style="color:white">Proceed To Checkout <i class="fa fa-arrow-right"></i></a></div>
                            <?php } ?>
                            ...
                            ?>
                        <?php $b_total = $cart_total;
                              $gdata = array();
                                    $gdata['b_total'] = $b_total;
            ...
            <div class="three wide column"> <br>
                <form class="ui form" action="<?php echo base_url()?>update-cart-qty" method="post">
                    ...
                    <input  type="hidden" name="rowid" value="<?php echo $items['rowid']?>">
                     <input type="submit" class="css_button2" value="Update Cart">
                </form>
            </div>
...
<?php } ?> 
        ...
        <div class="css_button2"><a href="<?php echo base_url()?>home" style="color:white">Continue Shopping</a></div>
                   ...
                   <!--  <p style="text-align:right"> Delivery <span style="text-align:right"> &emsp; Rs. 0.00</p> -->
                    ...
                    <div class="ui hidden divider"> </div>
                       ...
                       <form action="<?php echo base_url()?>update-cart-qty" method="post" >    
                            ...
                            <?php $shipping_id = $this->session->userdata('shipping_id');?>
                            <?php if($this->cart->total_items()!=Null && $customer_id!=NULL && $shipping_id!=NULL){?>
                            <div class="css_button_bottom"><a   href="<?php echo base_url()?>payment" style="color:white">Proceed To Checkout <i class="fa fa-arrow-right"></i></a></div>
                            <?php } elseif($customer_id!=NULL && $this->cart->total_items()!=Null){?>
                            <div class="css_button_bottom"><a  href="<?php echo base_url()?>billing" style="color:white">Proceed To Checkout <i class="fa fa-arrow-right"></i></a></div>
                            <?php }elseif($this->cart->total_items()!=Null){ ?>
                            <div class="css_button_bottom"><a   href="<?php echo base_url()?>checkout" style="color:white">Proceed To Checkout <i class="fa fa-arrow-right"></i></a></div>
                            <?php } ?>
                            </form> 
    ...
    <div class="mobile_cart">
        <div class='ui grid container'>
            ...
            <div class="row">
<div class="seven wide column left aligned column">
                <h4 id="cartpage_font"> Product Name </a> </h4>
            </div>
            ...
            <div class="three wide left aligned column">
                <h4 id="cartpage_font">Edit Cart</h4>
            </div>
        </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="three wide left aligned column">
                    <h4 id="cartpage_font"><?php echo $items['subtotal']?></h4>
                </div>
                <div class="three wide left aligned column">
                    <h4 id="cartpage_font"><?php echo $items['subtotal']?></h4>
                </div>
            ...
            <div class="three wide left aligned column">
                          <form class="ui form" action="<?php echo base_url()?>update-cart-qty" method="post">
          <input  type="text"  style="width: 50px; text-align: center; margin: 0px;" name="qty" value="<?php echo $items['qty']?>" autocomplete="off" size="2">
          <input  type="hidden" name="rowid" value="<?php echo $items['rowid']?>">
          <input type="submit" class="css_button2" value="Update">
            </form>
            </div>
        ...
        <div class="ui centered grid">
            <div class="column row">
                <div class="right floated column">
                   ...
                   <!--  <p style="text-align:right">Subtotal  &emsp; Rs. <?php echo $items['subtotal']?>.00  </p> -->
                   <!--  <p style="text-align:right"> Delivery <span style="text-align:right"> &emsp; Rs. 0.00</p> -->
                      <?php 
                                $cart_total = $this->cart->total();
                            ?>
