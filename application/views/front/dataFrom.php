...
<body>
	<form method="post" name="customerData" action="ccavenue">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>CC Avenue</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="214106"/></td>
				</tr>
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="123654789"/></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?php echo $this->session->userdata('b_total')?> "/></td>
				</tr>
				<tr>
					<td>Currency	:</td><td><input type="text" name="currency" value="INR"/></td>
				</tr>
				<tr>
					<td>Redirect URL	:</td><td><input type="hidden" name="redirect_url" value="http://jkcheesenmore.com/order-success"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="hidden" name="cancel_url" value="http://jkcheesenmore.com/checkout/cancel_payu"/></td>
			 	</tr>
			 	<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?php echo $this->session->userdata('cus_name')?>"/></td>
		        </tr>
				
				<tr>
		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?php echo $this->session->userdata('cus_email')?>"/></td>
		        </tr>
