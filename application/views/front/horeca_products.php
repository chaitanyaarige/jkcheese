...
<div class="productpage-computer">
    ...
    <?php  if(empty($post_by_brand_id)){ ?>
    <p class="ui centered  header">There are no product available.Please check other category</p>
    <?php } ?>
...
<div class="productpage-mobile" id="menuleft">
    ...
    <?php  if(empty($post_by_brand_id)){ ?>
    <p class="ui centered">There are no product available.Please check other category</p>
    <?php } ?>
