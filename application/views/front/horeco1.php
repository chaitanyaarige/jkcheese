            ...
            <div class="container">
                <form method="post" action="<?php echo base_url()?>contact-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" name="contact_number" placeholder="Email">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <select id="horecojose14">
                                <option id="horecojose14" value="0">Wholesale</option>
                                <option id="horecojose14" value="1">Retail</option>
                                <option id="horecojose14" value="2">General Enquiry</option>
                                <option id="horecojose14" value="3">New Business</option>
                                <option id="horecojose14" value="4">Delivery</option>
                            </select>
                        </div>
                    </div>
...
.required:after{ 
    ...
    .parallax_horeco {
        /* The image used */
        background-image: url("assets/images/horeco.jpg");
